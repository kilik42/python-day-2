...
print(new_phrase[1])#prints the second letter of the phrase
print(new_phrase[2])#prints the third letter of the phrase
print(new_phrase[11])#prints the fourth letter of the phrase
